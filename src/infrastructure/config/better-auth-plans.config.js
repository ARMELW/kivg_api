...
exports.getBetterAuthPlans = getBetterAuthPlans;
 ...
 */
function getBetterAuthPlans() {
    return __awaiter(this, void 0, void 0, function () {
        var planRepository, plans, betterAuthPlans, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    planRepository = new plan_repository_1.PlanRepository();
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, planRepository.findAll({ isActive: true, isPublic: true })
                ...
                case 2:
                    plans = _a.sent();
                    betterAuthPlans = plans
                        .filter(function (plan) { return plan.stripeProductId && plan.stripePriceIdMonthly; }) // Only include plans with Stripe product and at least monthly price
                        .map(function (plan) {
                        var stripePlan = {
                            name: plan.name,
                            priceId: plan.stripePriceIdMonthly // Safe because filter ensures this exists
                        };
                    ...
                    return [2 /*return*/, betterAuthPlans];
                case 3:
                    error_1 = _a.sent();
                    console.error('Error fetching plans for Better Auth:', error_1);
